...
def load_csv(spark, path):
    ...
    deposit_csv = spark.read.options(header=True).schema(schema).csv(path)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input", help="CSV path", default="./input/deposit_sample_data.csv"
    )

    parser.add_argument(
        "--output", help="Parquet path", default="./output/deposits.parquet"
    )
